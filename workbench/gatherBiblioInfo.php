...
/* Google API key                          **
** AIzaSyCY1rgFzozQjndaDJNi_UqAccWxaBQ8NgI */

/* ISBNdb                                                **
** http://isbndb.com/api/v2/xml/VC7FRDXP/books?q=9780816081530 */
            ...
            switch ($marcfield) {
                ...
                case 995:
                    if ($itemtype != 'REVUE') {
                        ...
                        if ($itemlostcode > 0 || $withdrawncode) {
...
function getLabel($cat, $key)
{
    ...
    if ($cat == 'BRANCH') {
        ...
        $query = 'SELECT description FROM itemtypes WHERE itemtype= "' . $key . '";';
    } else {
        $query = 'SELECT lib FROM authorised_values WHERE category= "' . $cat . '" AND authorised_value = "' . $key . '";';
    }
